...
THREE.Color.prototype.copyGammaToLinear = function( color, gammaFactor = 2.0 ) {
...
class RaytracingRenderer extends THREE.EventDispatcher {
    constructor ( parameters ) {
        ...
        var headless = parameters.headless !== undefined ? parameters.headless : true;
        var context;
            ...
            return function renderBlock( blockX, blockY ) {
                ...
                for ( var y = 0; y < blockSize; y ++ ) {
                    ...
                    for ( var x = 0; x < blockSize; x ++, index += 4 ) {
                        ...
                        var tx = x + blockX;
                        var ty = y + blockY;
                        var tindex = (ty * canvasWidth + tx) * 4;

                        // var tindex = index;
                        // console.log(tindex);

                        data[ tindex ]     = Math.sqrt( pixelColor.r ) * 255;
                        data[ tindex + 1 ] = Math.sqrt( pixelColor.g ) * 255;
                        data[ tindex + 2 ] = Math.sqrt( pixelColor.b ) * 255;
                        data[ tindex + 3 ] = 255
                    }
